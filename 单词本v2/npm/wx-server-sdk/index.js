                ...
                return tslib_1.__generator(this, function(_a) {
                    switch (_a.label) {
                      ...
                      case 1:
                        ...
                        return [ 4 /*yield*/ , tcbRequest({
                            params: tslib_1.__assign({}, options, {
                                action: "database.removeDocument",
                                collectionName: options.collectionName
                            }),
                            config: mergeConfig(tcb.config, config),
                            method: "post",
                    ...
                    switch (_a.label) {
                      ...
                      case 2:
                        ...
                        if (res.code && error_config_1.TCB_ERR_CODE[res.code] !== 0) {
                            ...
                            fileList = (res.fileList || []).filter(function(s) {
                                return Boolean(s);
                            }).map(function(f) {
    ...
    /***/ function(module, exports, __webpack_require__) {
        ...
        var provider = {
            ...
            sendRequest: function(options) {
                return tslib_1.__awaiter(this, void 0, void 0, function() {
                    return tslib_1.__generator(this, function(_a) {
                        return [ 2 /*return*/ , tcbRequest(tslib_1.__assign({
                            config: tcb.config,
                            params: options.data
                        }, options)) ];
                    });
  ...
  \*****************************/
    ...
    /***/ function(module, exports, __webpack_require__) {
        ...
        function assertType(param, ref, name, ErrorClass) {
            ...
            if (ErrorClass === void 0) {
                ErrorClass = error_1.CloudSDKError;
            }
  ...
  \***************************/
    ...
    /***/ function(module, exports, __webpack_require__) {
        ...
        exports.isObject = function(x) {
            return exports.getType(x) === "object";
        };
        exports.isString = function(x) {
            return exports.getType(x) === "string";
        };
        exports.isNumber = function(x) {
            return exports.getType(x) === "number";
        };
        exports.isPromise = function(x) {
            return exports.getType(x) === "promise";
        };
        ...
        exports.isDate = function(x) {
            return exports.getType(x) === "date";
        };
        exports.isInternalObject = function(x) {
            return x && x._internalType instanceof symbol_1.InternalSymbol;
        };
